...
main: vpctl build
.PHONY: all
all: clean main vpctl_test docker-vpctl docker-vproxy build
.PHONY: vpctl
vpctl:
...
# vproxy.io/controller-bundle:$VERSION and vproxy.io/controller-catalog:$VERSION.
IMAGE_TAG_BASE ?= vproxy.io/controller
...
IMG ?= vproxyio/controller:latest
