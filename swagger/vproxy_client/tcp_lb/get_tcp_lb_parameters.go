...
// WithDefaults hydrates default values in the get Tcp lb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTCPLbParams) WithDefaults() *GetTCPLbParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the get Tcp lb params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *GetTCPLbParams) SetDefaults() {
