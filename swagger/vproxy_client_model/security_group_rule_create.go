...
func (m *SecurityGroupRuleCreate) contextValidateProtocol(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SecurityGroupRuleCreate) contextValidateRule(ctx context.Context, formats strfmt.Registry) error {
