	...
	if m.ServerGroup != nil {
		if err := m.ServerGroup.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("serverGroup")
			}
			return err
		}
	}
...
func (m *ServerGroupInUpstreamDetail) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateServerGroup(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *ServerGroupInUpstreamDetail) contextValidateServerGroup(ctx context.Context, formats strfmt.Registry) error {

	if m.ServerGroup != nil {
		if err := m.ServerGroup.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("serverGroup")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("serverGroup")
