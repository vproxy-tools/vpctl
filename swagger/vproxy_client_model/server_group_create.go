...
func (m *ServerGroupCreate) contextValidateMethod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServerGroupCreate) contextValidateProtocol(ctx context.Context, formats strfmt.Registry) error {
