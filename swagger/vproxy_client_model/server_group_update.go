...
func (m *ServerGroupUpdate) contextValidateMethod(ctx context.Context, formats strfmt.Registry) error {
...
func (m *ServerGroupUpdate) contextValidateProtocol(ctx context.Context, formats strfmt.Registry) error {
