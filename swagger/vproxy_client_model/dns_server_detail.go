...
func (m *DNSServerDetail) contextValidateEventLoopGroup(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DNSServerDetail) contextValidateRrsets(ctx context.Context, formats strfmt.Registry) error {

	if m.Rrsets != nil {
		if err := m.Rrsets.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("rrsets")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("rrsets")
...
func (m *DNSServerDetail) contextValidateSecurityGroup(ctx context.Context, formats strfmt.Registry) error {
