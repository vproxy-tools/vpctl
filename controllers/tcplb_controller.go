...
//+kubebuilder:rbac:groups=vproxy.io.vproxy.io,resources=tcplbs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=vproxy.io.vproxy.io,resources=tcplbs/finalizers,verbs=update
